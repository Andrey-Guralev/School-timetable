                            ...
                            <div>
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                        <header>
                                            <div>
                                                <h1 class="text-3xl bold">Изменение предмета</h1>
                                            </div>
                                        </header>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <div class="mt-1">
                                                <input type="text" v-bind:value="lesson.name" name="lesson" id="lesson" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Название">
                                            </div>
                                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            sendChanges: function (e) {
                ...
                this.name = document.querySelector('#lesson').value;

                axios.patch('/lesson/' + this.id, {'name': this.name})
                    .then(response => {
            ...
            getData: async function () {
                this.lesson = (await axios.get('/lesson/get/' + this.id)).data;
            },
