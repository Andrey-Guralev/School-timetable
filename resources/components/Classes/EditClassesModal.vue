                                ...
                                <div>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                            <header>
                                                <div>
                                                    <h1 class="text-3xl bold">Изменение класса</h1>
                                                </div>
                                            </header>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="mt-1">
                                                    <input type="text" name="type" id="number" v-bind:value="Class.number" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Номер">
                                                </div>
                                                <div class="mt-1">
                                                    <input type="text" name="type" id="letter" v-bind:value="Class.letter" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Буква">
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="mt-1 flex flex-col">
                                                    <div>
                                                        <input id="first" name="shift" type="radio" :checked="Class.shift === 0" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                                        <label for="first">1</label>
                                                    </div>
                                                    <div>
                                                        <input id="second" name="shift" type="radio" :checked="Class.shift === 1" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
...
export default {
    ...
    methods: {
        sendClass: async function () {
            this.getChanges();

            await axios.patch('/classes/edit/' + this.id, this.updatedClass)
                .then(response => {
        ...
        getChanges: function () {
            ...
            let rad = document.getElementsByName('shift');
