                                        ...
                                        <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                            <header>
                                                <div class="flex justify-between">
                                                    <h1 class="text-3xl bold">Создание события</h1>
                                            ...
                                            <div class="mt-4">
                                                <div class="mb-4">
                                                    ...
                                                    <input v-model="result.name" type="text" name="name" id="name" class="w-1/2 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Название" />
                                                </div>
                                            </div>

                                            <div class="mb-4">
                                                <label for="type" class="mb-2">Тип расписания:</label>
                                                <select v-model="result.type" id="type" name="type" class="mt-1 block w-1/2 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
    ...
    export default {
        ...
        methods: {
            ...
            save: async function () {
                ...
                await axios.post('/ring/event', this.result).then(function () {
                    this.closeModal();
                    this.$emit('update');
                }.bind(this));
            },
