                                        ...
                                        <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div class="mt-4">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" v-model:value="name" name="name" id="name" class="w-1/2 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Название" />
                                                </div>
                                                <div class="mb-4">
                                                    <label for="shift" class="mb-2">Смена:</label>
                                                    <select v-model="shift" id="shift" name="shift" class="mt-1 block w-1/2 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select v-model="type" id="shift" name="shift" class="mt-1 block w-1/2 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <div class="ml-4">
                                                            <div class="flex items-center mb-2">
                                                                ...
                                                                <input :id="'start-time-' + num" :name="'start-time-' + num" type="time" :class="num + ' ring-schedule start w-2/12 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md'">
                                                            </div>
                                                            <div class="flex items-center">
                                                                <label :for="'end-time-' + num" class="mr-2 text-center">Конец:</label>
                                                                <input :id="'end-time-' + num" :name="'end-time-' + num" type="time" :class="num + ' ring-schedule end w-2/12 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md'">
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    export default {
        ...
        methods: {
            save: function () {
                ...
                axios.post('/ring/store', this.result)
