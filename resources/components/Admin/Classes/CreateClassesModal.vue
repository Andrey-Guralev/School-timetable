                                    ...
                                    <div class="">
                                        ...
                                        <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="mt-1">
                                                    <input type="text" name="type" id="number" v-model="Class.number" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Номер">
                                                </div>
                                                <div class="mt-1">
                                                    <input type="text" name="type" id="letter" v-model="Class.letter" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Буква">
                                                </div>
                                            </div>
...
export default {
    ...
    methods: {
        sendClass: async function () {
            ...
            await axios.post('/classes/', this.Class)
                .then(response => {
