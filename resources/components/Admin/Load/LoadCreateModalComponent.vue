                            ...
                            <div>
                                ...
                                <div class="">
                                    ...
                                    <div class="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                                        <header>
                                            <div>
                                                <h1 class="text-3xl bold">Создание нагрузки</h1>
                                            </div>
                                        </header>
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <div class="mt-1">
                                                <select v-model="load.classId" name="lesson" id="class" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Название">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <div class="mt-1">
                                                <select v-model="load.lessonId" name="lesson" id="lesson" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Название">
                                                    <option v-for="lesson in lessons" v-bind:value="lesson.id">{{ lesson.name }}</option>
                                                </select>
                                            </div>
                                        </div>
