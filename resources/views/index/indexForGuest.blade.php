<x-app-layout>
    @if(Auth::guest() && !session('class'))
        <x-container class="" style="color: #003A80">
            ...
            <h2 class="sm:mt-4 lg:mt-1.5 text-2xl text-center">Чтобы посмотреть расписание надо <a href="{{ route('classesLogin') }}" class="text-blue-900 underline">выбрать класс</a></h2>
